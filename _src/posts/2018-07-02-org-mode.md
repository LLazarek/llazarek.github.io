...
For example, links completely eliminate typical email clutter;
...
For more about the agenda and optimizing its appearance to make surveying tasks quick and easy, check out [my other post](http://llazarek.github.io/2018/07/improving-the-agenda.html) on tweaking the agenda's display settings.
